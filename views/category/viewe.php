                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>
                                                <a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $product->id]) ?>"><?= $product->name ?></a>
                                            </p>
                    ...
                    foreach ($news as $new): ?>
                        ...
                        <div class="col-sm-3">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <a href="<?= Url::to(['product/viewe', 'id' => $new->id]) ?>">
                    ...
                    foreach ($sales as $sale): ?>
                        ...
                        <div class="col-sm-3">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <a href="<?= Url::to(['product/viewe', 'id' => $sale->id]) ?>">
                                        ...
                                        <p>
                                            <a href="<?= Url:: to(['product/viewe', 'id' => $sale->id]) ?>"><?= $sale->name ?></a>
                                        </p>
