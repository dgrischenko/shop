                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-sm-8 ">
                                <img src="/images/home/header7.jpg" class="girl img-responsive padding-right" alt=""/>
                        ...
                        <div class="item">
                            ...
                            <div class="col-sm-8">
                                <img src="/images/home/header5.jpg" class="girl img-responsive padding-right" alt=""/>
                                <!--      <img src="/images/home/pricing.png" class="pricing" alt=""/>-->
                            </div>
                        </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <p>
                                                    <a href="<?= Url:: to(['product/viewe', 'id' => $new->id]) ?>"><?= $new->name ?></a>
                                                </p>
                                                <?php
                                                echo $price->abr
                                                ?>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <p>
                                            <a href="<?= \yii\helpers\Url:: to(['product/viewe', 'id' => $hit->id, 'set' => 1]) ?>"><?= $hit->name ?></a>
                                        </p>
                                        <?php
                                        echo $price->abr
                                        ?>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <p>
                                            <a href="<?= \yii\helpers\Url:: to(['product/viewe', 'id' => $sale->id]) ?>"><?= $sale->name ?></a>
                                        </p>
                                        <?php
                                        echo $price->abr
                                        ?>
