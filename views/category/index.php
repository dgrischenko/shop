                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-sm-8 ">
                                <img src="/images/home/header2.jpg" class="girl img-responsive padding-right" alt=""/>
                        ...
                        <div class="item">
                            ...
                            <div class="col-sm-8">
                                <img src="/images/home/header-2.jpg" class="girl img-responsive padding-right" alt=""/>
                                <!--<img src="/images/home/pricing.png" class="pricing" alt=""/>-->
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="col-sm-8">
                                <img src="/images/home/header4.jpg" class="girl img-responsive padding-right" alt=""/>
                          <!--      <img src="/images/home/pricing.png" class="pricing" alt=""/>-->
                            </div>
                        </div>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <p>
                                            <a href="<?= Url:: to(['product/view', 'id' => $sale->id]) ?>"><?= $sale->name ?></a>
                                        </p>
                                        <?= $sale->fabr ?>
