                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>
                                                <a href="<?= \yii\helpers\Url::to(['product/viewu', 'id' => $product->id]) ?>"><?= $product->name ?></a>
                                            </p>
                    ...
                    foreach ($news as $new): ?>
                        ...
                        <div class="col-sm-3">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <a href="<?= Url::to(['product/viewu', 'id' => $new->id]) ?>">
                    ...
                    foreach ($hits as $hit): ?>
                        ...
                        <div class="col-sm-3">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <a href="<?= Url::to(['product/viewu', 'id' => $hit->id]) ?>">
                                        ...
                                        <p>
                                            <a href="<?= Url:: to(['product/viewu', 'id' => $hit->id]) ?>"><?= $hit->name ?></a>
                                        </p>
