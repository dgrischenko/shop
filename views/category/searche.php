                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $product->id]) ?>">
                                                <?php $mainImg = $product->getImage(); ?>
                                                <?= Html::img($mainImg->getUrl('x284'), ['alt' => $product->name])?></a>

                                            <h2>
                                                <?= round($product->price / $price['api'],2) . ' ' . $price->title ?>
                                            </h2>
                                            <p><a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $product->id]) ?>"><?= $product->name ?></a></p>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <!--<a href="<?/*= \yii\helpers\Url::to(['product/viewe', 'id' => $hit->id]) */?>"><?/*=Html::img("@web/images/products/{$hit->img}", ['alt' => $hit->name]) */?></a>-->

                                            <a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $sale->id]) ?>">
                                            ...
                                            <p><a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $sale->id]) ?>"><?= $sale->name ?></a></p>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $new->id]) ?>">
                                            ...
                                            <p><a href="<?= \yii\helpers\Url::to(['product/viewe', 'id' => $new->id]) ?>"><?= $new->name ?></a></p>
