                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="<?= \yii\helpers\Url::to(['product/viewu', 'id' => $product->id]) ?>">
                                            ...
                                            <p><a href="<?= \yii\helpers\Url::to(['product/viewu', 'id' => $product->id]) ?>"><?= $product->name ?></a></p>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <!--<a href="<?/*= \yii\helpers\Url::to(['product/viewu', 'id' => $hit->id]) */?>"><?/*=Html::img("@web/images/products/{$hit->img}", ['alt' => $hit->name]) */?></a>-->
                                            ...
                                            <p><a href="<?= \yii\helpers\Url::to(['product/viewu', 'id' => $sale->id]) ?>"><?= $sale->name ?></a></p>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p><a href="<?= \yii\helpers\Url::to(['product/viewu', 'id' => $new->id]) ?>"><?= $new->name ?></a></p>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>
                                                <a href="<?= \yii\helpers\Url::to(['product/viewu', 'id' => $hit->id]) ?>"><?= $hit->name ?></a>
                                            </p>
