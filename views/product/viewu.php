        ...
        <div class="row">
            ...
            <div class="col-sm-6 padding-right">
                ...
                <div class="product-information">
                    ...
                    <h2><?= $product->name ?></h2>
                    <p>Категория: <a
                                href="<?= \yii\helpers\Url::to(['category/viewu', 'id' => $product->category->id]) ?>"><?= $product->category->name ?>&trade;</a>
                    </p>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <p>
                                                    <a href="<?= \yii\helpers\Url:: to(['product/viewu', 'id' => $new->id]) ?>"><?= $new->name ?></a>
                                                </p>
